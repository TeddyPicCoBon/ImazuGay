...
local I = A:T("Trng thái","rbxassetid://10734984606")
local Mn = A:T("Chung","rbxassetid://10723407389")
local St = A:T("Cài t","rbxassetid://10734950309")
local M = A:T("Vt Phm","rbxassetid://10734975692")
local V4 = A:T("Tc - o Bí n","rbxassetid://10747372167")
local E = A:T("S Kin Bin","rbxassetid://10709761530")
local P = A:T("Ngi Chi","rbxassetid://10747373176")
local V = A:T("Th Giác","rbxassetid://10723346959")
local R = A:T("Tp Kích","rbxassetid://10723345749")
local T = A:T("Di Chuyn","rbxassetid://10723434557")
local S = A:T("Ca Hàng","rbxassetid://10734952479")
local D = A:T("Trái Ác Qu","rbxassetid://10709761889")
local Mc = A:T("Máy Ch","rbxassetid://10709782582")
--------------------------------------------------------------------------------------------------------
I:Seperator("Discord")

I:Label("Mi Ngi u Tham Gia Giao Lu")
I:Button("Copy Discord Link",function()
setclipboard("https://discord.gg/c5EYjcvC") 
end)

I:Seperator("Thi Gian")

Time = I:Label("Thi Gian Thc Hin")
...
Time:Set("[Sever Time]: Gi: "..Hour.." Phút: "..Minute.." Giây: "..Second)
end
...
UpdateClient1()
    ...
    I:Seperator("Trng Thái Ngi Chi")

    local localrace = I:Label("Tc")
    
    spawn(function()
        while wait() do
            pcall(function()
                localrace:Set("Tc:".." "..game:GetService("Players").LocalPlayer.Data.Race.Value)
            end)
        end
    end)
    ...
    local localfrag = I:Label("im F")
    
    spawn(function()
        while wait() do
            pcall(function()
                localfrag:Set("im F:".." "..game:GetService("Players").LocalPlayer.Data.Fragments.Value)
            end)
        end
    end)
    
    local localbountyhornor = I:Label("Tin Thng")
    
    spawn(function()
        while wait() do
            pcall(function()
                localbountyhornor:Set("Tin Thng:".." "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
            end)
        end
    end)
...
local WeaponList = {"Võ","Kim","Trái","Súng"}
_G.SelectWeapon = "Võ"
Mn:Dropdown("Chn V Khí",WeaponList,function(V)
_G.SelectWeapon = V
end)
...
local AttackList = {"Chm", "Bình Thng", "Nhanh", "Cc Nhanh"}
        ...
        if FireCooldown then
            pcall(function()
                if FireCooldown == "Chm" then
                    FireCooldown = 0.1
                elseif FireCooldown == "Bình Thng" then
                    FireCooldown = 0.07
...
Mn:Seperator("T ng Cày")

    Mn:Toggle("Cày Cp",_G.Farm,function(V)
        _G.Level = V
        StopTween(_G.Farm)
    end)
...
if World1 then
    Mn:Toggle("Cày Nhanh (Cp 1-300)",_G.FarmFast,function(V)
        _G.Farmfast = V
...
Mn:Toggle("Cày Cp Và Ly Vt Phm",false,function(V)
       _G.Level = V
   ...
   Mn:Toggle("Cày Quái  Gn",_G.FarmNearest,function(V)
   _G.FarmNearest = V
...
spawn(function()
    ...
    Mn:Seperator("Trùm Bí n")
    
    local Et = Mn:Label("Th sn tinh nhu")
     
	spawn(function()
		while wait() do
			Et:Set("Th sn tinh nhu: "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
		end
	end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Es:Set("Trng Thái: Có")	
				else
					Es:Set("Trng Thái: Không")	
				end
			end)
		end
	end)
	
    Mn:Toggle("ánh Trùm Bí n",_G.Elitehunter,function(V)
        _G.Elitehunter = V
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Mn:Toggle("ánh Và i Máy Ch",_G.EliteHunterHop,function(V)
        _G.EliteHunterHop = V
    end)
...
Mn:Toggle("Dng Khi Có Vt Phm",function(V)
	_G.StopItemsChest = V
end)
...
Mn:Toggle("Nht Rng o Kì Bí",false,function(V)
 _G.ChestMirage = V
...
spawn(function()
    ...
    Mn:Seperator("Cuc t kích ca cp bin")
    
    Mn:Toggle("ánh Hi Tc", _G.Carvender,function(V)
     _G.RaidPirate = V
...
BoneCheck = Mn:Label("Xng ang Có: N/A")
    
    spawn(function()
        while wait() do
            pcall(function()
                BoneCheck:Set("Xng ang Có: "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end)
        end
    end)

    Mn:Toggle("Cày Xng",_G.Bone,function(V)
        _G.Bone = V
        StopTween(_G.Bone)
    end)
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    Mn:Toggle("i Xng",_G.Random_Bone,function(V)
        _G.Random_Bone = V
    end)
    ...
    Mn:Toggle("T ng Cu Nguyn",pry,function(V)
    _G.Pray = V
    end)
    ...
    Mn:Toggle("T ng Th Vn May",Trylux,function(V)
    _G.Trylux = V
    end)
...
spawn(function()
        ...
        while wait() do
            pcall(function()
                ...
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    ...
                    MobKilled:Set("Trùm Xut Hin")
                end
            end)
        end
    end)
    
    Mn:Toggle("Cày Hoàng T Bánh",_G.DoughtBoss,function(V)
        _G.DoughtBoss = V
    ...
    Mn:Toggle("T ng Triu Hi Trùm",false,function(V)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Mn:Toggle("T ng Vua Bt", _G.doughking,function(V)
         _G.doughking = V
        StopTween( _G.doughking)
    end)
    
    Mn:Toggle("Vua Bt i Máy Ch", _G.doughkingHop,function(V)
         _G.doughkingHop = V
    end)
   ...
   Mn:Seperator("Thông Tho")
    
    Mn:Toggle("Cày Thông Tho Trái",_G.FarmFruitMastery,function(V)
    ...
    Mn:Toggle("Cày Thông Tho Súng ",_G.FarmGunMastery,function(V)
        _G.FarmGunMastery = V
    ...
    Mn:Toggle("Cày Haki Và i Máy Ch",_G.Observation_Hop,function(V)
    ...
    local Boss = Mn:Label("Trng Thái : Chn Trùm")
    ...
    Mn:Toggle("ánh Trùm",_G.FarmBoss,function(V)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
        _G.FarmBoss = V
    ...
    Mn:Toggle("ánh Tt C Trùm",_G.AllBoss,function(V)
        _G.AllBoss = V
        StopTween(_G.AllBoss)
    end)
    
    Mn:Toggle("ánh Tt C Và i Máy Ch",_G.AllBossHop,function(V)
        _G.AllBossHop = V
    end)
...
St:Toggle("Duy Chuyn Dng Reset",BypassTP,function(V)
BypassTP = V
end)

St:Seperator("Di Chuyn")

local SpeedList = {"100", "150", "250", "300", "325", "350"}
getgenv().TweenSpeed = "350"
St:Dropdown("Tc  Bay", SpeedList,function(V)
    getgenv().TweenSpeed = V
end)

    St:Button("Dng Bay",function()
        topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Clip = false
    end)
...
local Bring = {"Ít", "Trung Bình", "Nhiu"}
_G.BringMode = "Ít"
St:Dropdown("Ch  Gôm Quái", Bring,function(V)
    _G.BringMode = V
end)
spawn(function()
    while wait(.1) do
        if _G.BringMode then
            pcall(function()
                ...
                elseif _G.BringMode == "Trung Bình" then
                    _G.BringMode = 300
                elseif _G.BringMode == "Nhiu" then
                    _G.BringMode = 350
                end
            end)
        end
...
St:Toggle("T ng Bt Haki",true,function(V)
_G.Haki = V
end)
spawn(function()
    while wait(.1) do
...
St:Toggle("ánh Nhanh",true,function(r1736_51)
...
St:Toggle("Tt Hiu ng ánh",true,function(V)
NoAttackAnimation = V
end)

St:Toggle("Tt Thông Báo",false,function(V)
_G.Remove_trct = V
end)
...
St:Toggle("Tt m Sát Thng",true,function(Remo)
...
St:Toggle("Màn Hình Trng",_G.WhiteScreen,function(V)
    _G.WhiteScreen = V
...
elseif _G.WhiteScreen == false then
    ...
    St:Toggle("n Quái",_G.hadesinvis,function(V)
    _G.hadesinvis = V
    ...
    St:Seperator("Cài t Cày Thông Tho")
...
if World1 or World2 then
    ...
    if World1 then
        M:Toggle("T ng Qua Sea 2",_G.SecondSea,function(V)
            _G.SecondSea = V
    ...
    if World2 then
        ...
        M:Toggle("T ng Qua Sea 3",_G.ThirdSea,function(V)
            _G.ThirdSea = V
    ...
    if World2 then
        M:Toggle("ánh Nhà Máy",_G.Factory,function(V)
            _G.Factory = V
    ...
    M:Seperator("Phong Cách Chin u")
    
    M:Toggle("T ng Ly Superhuman",_G.Superhuman,function(V)
        _G.Superhuman = V
    end)
    ...
    M:Toggle("T ng Ly DeathStep",_G.DeathStep,function(V)
        _G.DeathStep = V
    end)
    ...
    M:Toggle("T ng Ly Sharkman Karate",_G.Sharkman,function(V)
        _G.Sharkman = V
    end)
    ...
    M:Toggle("T ng Ly Electric Claw",_G.ElectricClaw,function(V)
        _G.ElectricClaw = V
    ...
    M:Toggle("T ng Ly Dragon Talon",_G.DragonTalon,function(V)
        _G.DragonTalon = V
    end)
    ...
    M:Toggle("T ng Ly GodHuman",_G.God_Human,function(V)
 _G.God_Human = V
end)
spawn(function()
    while task.wait() do
...
M:Seperator("Nguyên Liu")

if World2 then
M:Toggle("Cày Vt Liu Phóng X",false,function(V)
Radioactive = V
...
if World2 then  
M:Toggle("Cày Git Nc Huyn Bí",false,function(V)
_G.Makori_gay = V
...
if World1 or World2 then
M:Toggle("Cày Qung Dung Nham",_G.Makori_gay,function(V)
_G.Umm = V
StopTween(_G.Umm)
end)
...
if World1 then  
M:Toggle("Cày ôi Cánh Thiên Thn",_G.Makori_gay,function(V)
_G.Wing = V
StopTween(_G.Wing)
end)
...
if World1 or world2 or World3 then    
M:Toggle("Cày Kim Loi Ph Liu",false,function(V)
Scrap = V
StopTween(Scrap)
end)
...
if World3 then     
M:Toggle("Cày Vy Rng",false,function(V)
Dragon_Scale = V
...
if World3 then    
M:Toggle("Cày Thuc Súng",false,function(V)
Gunpowder = V
StopTween(Gunpowder)
end)
...
if World3 then     
M:Toggle("Cày uôi Cá",false,function(V)
Fish = V
StopTween(Fish)
end)
...
if World3 then  
M:Toggle("Cày Sng Tê Giác",false,function(V)
MiniHee = V
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:Seperator("Tp Kích Nâng Cao")
    
    M:Toggle("Cày Phoenix Tp Kích",_G.AdvanceDungeon,function(V)
        _G.AdvanceDungeon = V
    ...
    M:Toggle("ánh Cá Ca", _G.doughking,function(V)
         _G.saw = V
        StopTween( _G.saw)
    end)
    
    M:Toggle("ánh Cá Ca i Máy Ch", _G.doughkingHop,function(V)
         _G.sawhop = V
    end)
	...
	M:Seperator("Kim Waden")
	
	M:Toggle("Ly Kim Waden", _G.waden,function(V)
         _G.waden = V
        StopTween( _G.waden)
    end)
    
    M:Toggle("Ly Kim Waden i Máy Ch", _G.wadenhop,function(V)
         _G.wadenhop = V
    end)
    ...
    M:Toggle("ánh Râu Xám", _G.doughking,function(V)
         _G.gay = V
        StopTween( _G.gay)
    end)
    
    M:Toggle("ánh Râu Xám i Máy Ch", _G.doughkingHop,function(V)
         _G.gayhop = V
    end)
    ...
    M:Toggle("Ly Saber",_G.Saber,function(V)
			...
			M:Toggle("Ly Saber i Máy Ch",_G.SaberHop,function(V)
				_G.SaberHop = V
			end)
 ...
 spawn(function()
    ...
    M:Toggle("Ly Gy Lôi v1", _G.doughking,function(V)
         _G.pole = V
        StopTween( _G.pole)
    end)
    
    M:Toggle("Gy Lôi v1 i Máy Ch", _G.doughkingHop,function(V)
         _G.polehop = V
    end)
...
local PolePos = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
    ...
    M:Seperator("Thanh Kim Huyn Thoi")

    M:Toggle("Mua Kim Huyn Thoi",_G.BuyLegendarySword,function(V)
        _G.BuyLegendarySword = V
    end)
    ...
    M:Toggle("Mua Kim Huyn Thoi i Máy Ch",_G.BuyLegendarySword_Hop,function(V)
        _G.BuyLegendarySword_Hop = V
    end)
    
    M:Seperator("Haki V Trang Màu")
    ...
    M:Toggle("Mua Haki Màu i Máy Ch",_G.BuyEnchancementColour_Hop,function(V)
    ...
    M:Toggle("Làm Nhim V Bartlio",_G.Bartilo,function(V)
        _G.Bartilo = V
    end)
    ...
    M:Toggle("Ly Kính Thiên Nga",_G.FarmSwanGlasses,function(V)
    ...
    M:Toggle("Ly Kính Thiên Nga i Máy Ch",_G.FarmSwanGlasses_Hop,function(V)
        _G.FarmSwanGlasses_Hop = V
    end)
    
    M:Toggle("T ng Nâng Tc V2",_G.EvoRace,function(V)
        _G.EvoRace = V
    ...
    M:Seperator("Vt Cht Kì D")
    
    M:Toggle("Cày Vt Cht Kì D",_G.Ectoplasm,function(V)
        _G.Ectoplasm = V
    ...
    M:Seperator("Kim Rengoku")
    
    M:Toggle("Ly Kim Rengoku",_G.Rengoku,function(V)
        _G.Rengoku = V
    ...
    M:Seperator("Kim inh Ba Rng")
    
	M:Toggle("Ly inh Ba Rng", _G.Dragon_Trident,function(V)
         _G.Dragon_Trident = V
        StopTween(_G.Dragon_Trident)
    end)
    
    M:Toggle("Ly inh Ba Rng i Máy Ch", _G.Dragon_Trident_Hop,function(V)
    ...
    M:Toggle("ánh Rip_Indra True",_G.DarkDagger,function(V)
        _G.DarkDagger = V
    ...
    M:Toggle("ánh Rip_Indra True i Náy Ch",_G.DarkDagger_Hop,function(V)
        _G.DarkDagger_Hop = V
    end)
...
M:Toggle("T ng Nhn Màu Haki",_G.Ob_Color,function(V)
	Open_Color_Haki = V
...
function EquipAllWeapon()
    ...
    M:Seperator("Lính Ng Lâm")
    
    M:Toggle("Làm Nhim V Ng Lâm",_G.MusketeerHat,function(V)
        _G.MusketeerHat = V
    ...
    M:Seperator("Kim Móc ôi")
    
    M:Toggle("Ly Móc ôi", _G.TwinHook,function(V)
         _G.TwinHook = V
        StopTween( _G.TwinHook)
    end)
    
    M:Toggle("Ly Móc ôi i Máy Ch", _G.TwinHook_Hop,function(V)
         _G.TwinHook_Hop = V
    end)
    ...
    M:Toggle("Ly Haki 7 Màu",_G.Rainbow_Haki,function(V)
        _G.Rainbow_Haki = V
    ...
    M:Toggle("Làm Nhim V Haki Quan Sát V2",_G.Observationv2,function(V)
        _G.Observationv2 = V
    ...
    M:Toggle("Ly Carvander i Máy Ch", _G.Carvenderhop,function(V)
         _G.Carvenderhop = V
    end)
...
M:Toggle("Ly Tushita", _G.tushita,function(V)
    ...
    M:Toggle("Ly Tushita i Máy Ch", _G.tushitahop,function(V)
         _G.tushitahop = V
    end)
    ...
    M:Toggle("T ng Cm ut",_G.HolyTorch,function(V)
        _G.HolyTorch = V
    ...
    M:Seperator("Kim Li Hái")
    
    M:Toggle("Ly Li Hái",_G.FarmBossHallow,function(V)
        _G.FarmBossHallow = V
        StopTween(_G.FarmBossHallow)
    end)
    
    M:Toggle("Ly Li Hái i Máy Ch",_G.FarmBossHallowHop,function(V)
    ...
    M:Toggle("Ly àn Ghita Linh Hn ( Th )",_G.Guitar,function(V)
  _G.Guitar = V    
 StopTween(_G.Guitar)
 end)
...
M:Toggle("Ly Ghita Linh Hn i Máy Ch",false,function(V)
  _G.soulGuitarhop = V    
 end)
    
    M:Seperator("Kim Buddy")
    ...
    M:Toggle("Ly Buddy i Máy Ch",_G.BudySwordHop,function(V)
        _G.BudySwordHop = V
    end)
 ...
 M:Seperator("Song Kim Nguyn Ra")

M:Toggle("Ly! Song Kim Nguyn Ra ( Th )",_G.Cdk,function(V)
 _G.CDK = V
StopTween(_G.CDK)
end)
...
V4:Toggle("T ng o Bí n",_G.MysticIsland,function(V)
        _G.MysticIsland = V
    ...
    V4:Toggle("Lái Thuyn",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    V4:Toggle("T ng Triu Hi o Bí n",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
V4:Toggle("Bay n Ông Bán Trái o Bí n",_G.TPNPC,function(V)
             _G.Miragenpc = V
...
V4:Button("Bay n Ông Bán Trái o Bí n", function()
                TweenNpc()
                end)
...
V4:Toggle("Nhìn Trng",_G.LockCamToMoon,function(V)
    _G.LockCamToMoon = V
end)
...
V4:Toggle("Bay n Bánh Rng",_G.TweenMGear,function(V)
_G.TweenMGear = V
...
V4:Button("Bay ên nh Cây i Th",function()
  topos(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
end)
    
V4:Button("Vào Ngôi n Thi Gian",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286, 14897, 103)
end)
    
V4:Button("Bay n Cn Gt",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

V4:Button("Bay n Ch Bán Bánh Rng",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)

V4:Button("Truy Cp ng H", function()
    game:GetService("Workspace").Map["Temple of Time"].DoNotEnter:Remove()
    game:GetService("Workspace").Map["Temple of Time"].ClockRoomExit:Remove()
end)

V4:Toggle("Mua Bánh Rng",_G.Bone4,function(V)
 _G.Bone4 = V
 StopTween(_G.Bone4)
end)
spawn(function()
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  V4:Button("Bay n Tc Bn Thân",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286, 14897, 103)
    wait(.1)
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286, 14897, 103)
    wait(.1)
...
V4:Button("Bay n ng H",function()
	topos(CFrame.new(29551.9941, 15069.002, -85.5179291))
end)

  V4:Toggle("T ng Qua i",false,function(v)
  _G.QuestRace = v
...
V4:Toggle("Cày & Bc Tc",false,function(V)
    _G.Bone = V
    _G.Bone4 = V
    _G.ActiveV4 = V
    StopTween(_G.Bone)
...
V4:Toggle("Git Ngi Chi i",false,function(V)
...
spawn(function()
  ...
  V4:Button("Mua Bánh Rng",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
  end)
end
--------------------------------------------------------------------------------------------------------
    E:Button("Xoá Xng Mù",function()
...
local ListSeaBoat = {
    ...
    E:Dropdown("Chn Thuyn",ListSeaBoat,function(V)
        _G.SelectedBoat = V
    end)
    ...
    E:Dropdown("Chn Vùng",ListSeaZone,function(V)
        _G.SelectedZone = V
    end)
    ...
    E:Dropdown("Chn Tc  Ca Thuyn",{"180", "200", "250", "300", "325", "350"},function(V)
        getgenv().SpeedBoat = V
    end)
    
    E:Toggle("Bt u S Kin Bin",_G.SailBoat,function(V)
        _G.SailBoat = V
    end)
...
spawn(function()
    ...
    E:Toggle("ánh Cá",FarmShark,function(V)
        FarmShark = V
        StopTween(FarmShark)
    end)
    
    E:Toggle("ánh Piranha",_G.farmpiranya,function(V)
        _G.farmpiranya = V
        StopTween(_G.farmpiranya)
    end)
    
    E:Toggle("ánh Fish Crew",_G.Fish_Crew_Member,function(V)
    ...
    E:Toggle("ánh Thuyn Ma",_G.bjirFishBoat,function(V)
        _G.bjirFishBoat = V
    ...
    E:Toggle("ánh Thuyn",_G.KillGhostShip,function(V)
        _G.KillGhostShip = V
    ...
    E:Toggle("ánh Terror Shark",_G.Terrorshark,function(V)
        _G.Terrorshark = V
        StopTween(_G.Terrorshark)
    end)
    
    E:Toggle("ánh Sea Beast",_G.SeaBest,function(V)
        _G.SeaBest = V
...
local ListBright = {
    ...
    E:Dropdown("Chn  Sáng",ListBright,function(V)
        BrightValue = V
    end)
    
    E:Button("Bc  Sáng ã Chn",function()
        game:GetService("Lighting").Brightness = BrightValue
    end)
    
    E:Toggle("Tng Tc  Thuyn",_G.IncreaseBoatSpeed,function(V)
    ...
    E:Toggle("Xuyên á",_G.NoClipRock,function(V)
        _G.NoClipRock = V
    end)
            spawn(function()
                while wait() do
    ...
    E:Toggle("T ng Nhn W",_G.r71PressW,function(V)
        _G.r71PressW = V
    end)
            spawn(function()
                while wait() do
...
E:Seperator("Cài t Chiêu S Kin Bin")

    E:Toggle("Bc Chiêu Ca Võ",_G.UseSeaMeleeSkill,function(V)
        _G.UseSeaMeleeSkill = V
    end)

    E:Toggle("Bc Chiêu Ca Trái",_G.UseSeaFruitSkill,function(V)
        _G.UseSeaFruitSkill = V
    end)
   
    E:Toggle("Bc Chiêu Ca Kim",_G.UseSeaSwordSkill,function(V)
        _G.UseSeaSwordSkill = V
    end)
    
    E:Toggle("Bc Chiêu Ca Súng",_G.UseSeaGunSkill,function(V)
        _G.UseSeaGunSkill = V
    end)
    
E:Seperator("Cài t Chiêu Ca Võ")

    E:Toggle("S Dng Chiêu Z Ca Võ",_G.UseSeaFruitSkill,function(V)
        _G.SkillMeleeZ = V
    end)
   
    E:Toggle("S Dng Chiêu X Ca Võ",_G.UseSeaSwordSkill,function(V)
        _G.SkillMeleeX = V
    end)
    
    E:Toggle("S Dng Chiêu C Ca Võ",_G.UseSeaGunSkill,function(V)
        _G.SkillMeleeC = V
    end)
   
E:Seperator("Cài t Chiêu Ca Trái")

    E:Toggle("S Dng Chiêu Z Ca Trái",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitZ = V
    end)
   
    E:Toggle("S Dng Chiêu X Ca Trái",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitX = V
    end)
   
    E:Toggle("S Dng Chiêu C Ca Trái",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitC = V
    end)
   
       E:Toggle("S Dng Chiêu V Ca Trái",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitV = V
    end)
   
       E:Toggle("S Dng Chiêu F Ca Trái",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitF = V
    end)
   
E:Seperator("Cài t Chiêu Ca Súng Và Kim")

       E:Toggle("S Dng Chiêu Z Ca Súng Và Kim",_G.UseSeaFruitSkill,function(V)
        _G.SkillGunZ = V
        _G.SkillSwordZ = V
    end)
   
       E:Toggle("S Dng Chiêu X Ca Súng Và Kim",_G.UseSeaFruitSkill,function(V)
        _G.SkillGunX = V
        _G.SkillSwordX = V
    end)
...
spawn(function()
    ...
    E:Toggle("T ng o Bng",_G.FrozenDimension,function(V)
    _G.FrozenDimension = V
    StopTween(_G.FrozenDimension)
    end)
    
    E:Seperator("S Kin o Cáo")
    
    E:Toggle("T ng o Cáo",_G.FKitsune,function(V)
    _G.FKitsune = V
...
E:Toggle("Bay n o Cáo", false, function(V)
    _G.tpkit = V
    StopTween(_G.tpkit)
end)
...
E:Toggle("Nht Ngn La Xanh", false, function(V)
    _G.CltAze = V
    StopTween(_G.CltAze)
...
E:Button("i Ngn La Xanh",function()
game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/KitsuneStatuePray"):InvokeServer()
 end)
--------------------------------------------------------------------------------------------------------
V:Seperator("nh V")

V:Toggle("nh V Ngi Chi",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
V:Toggle("nh V o Cáo",false,function(V)
        IslandESP = V
...
function UpdateIslandESPKitsune()
    ...
    V:Toggle("nh V Rng",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    V:Toggle("nh V Trái",false,function(a)
        DevilFruitESP = a
    ...
    V:Toggle("nh V Hoa Qu",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    V:Toggle("nh V Hoa",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
V:Toggle("nh V o",IslandESP,function(V)
        IslandESP = V
        while IslandESP do wait()
            UpdateIslandESP() 
        end
...
V:Toggle("nh v o Bí n", false, function(V)
    MirageIslandESP = V
...
V:Button('Cp /Beli/EXP Tc Thi', function()
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  V:Toggle("n Bn Tin Thng", _G.leaderboard, function(a)
    _G.leaderboard = a
...
elseif type(Ability) == 'table' then
   ...
   V:Button("M Khoá Geppo",function()
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    V:Button("Phóng To Ti a", function()
		while wait() do
			game.Players.LocalPlayer.CameraMaxZoomDistance = 9223372036854718
			end
	end)

V:Button("Hin Toàn B Thông Tin", function(V)
...
V:Seperator(" Ho")
    ...
    V:Button("Xoá Sng Mù ( Bin 3 )",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)

V:Toggle("Xoá Sng Mù",RemoveFog,function(V)
    RemoveFog = V
    ...
    V:Toggle("Xoá Sát Thng",true,function()
    ...
    V:Button("M Khoá FPS",function()
        setfpscap(9999999)
    end)
    
    V:Button("Gim  Ho", function()
    ...
    V:Toggle("Không Có Thi Gian Hi Chiêu",false,function(V)
        nododgecool = V
        NoDodgeCool()
    end)
    
    V:Toggle("Vô Hng Nng Lng",false,function(V)
        InfiniteEnergy = V
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    V:Toggle("Kh Nng Vô Hn",false,function(V)
        InfAbility = V
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    V:Toggle("Vô Hn Haki Quan Sát",getgenv().InfiniteObRange,function(V)
    ...
    V:Toggle("Geppo Vô Hn",getgenv().InfGeppo,function(V)
        getgenv().InfGeppo = V
    end)
    ...
    V:Toggle("Soru Vô Hn",_G.Infsoru,function(V)
        _G.Infsoru = V
    end)
...
--------------------------------------------------------------------------------------------------------
    local plyserv = P:Label("Ngi Chi")
        ...
        while wait() do
            pcall(function()
                for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                    if i == 12 then
                        plyserv:Set("Ngi Chi:".." "..i.." ".."/".." ".."12".." ".."(Max)")
                    elseif i == 1 then
                        plyserv:Set("Ngi Chi:".." "..i.." ".."/".." ".."12")
                    else
                        plyserv:Set("Ngi Chi:".." "..i.." ".."/".." ".."12")
                    end
                end
    ...
    local SelectedPly = P:Dropdown("Chn Ngi Chi",Playerslist,function(V)
        _G.SelectPly = V
    end)
    
    P:Button("Làm Mi",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    P:Toggle("Xem Ngi Chi",false,function(V)
        SpectatePlys = V
    ...
    P:Toggle("Bay n Ngi Chi",false,function(V)
        _G.TeleportPly = V
        pcall(function()
    ...
    P:Toggle("Bay Dng Dch Chuyn n Ngi Chi",false,function(bool)
                                    _G.Teleport = bool
    ...
    P:Seperator("Nhim V Ngi Chi")
    
    P:Button("Nhn Nhim V Git Ngi Chi",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    P:Toggle("Git Ngi Chi ang Nhm Nhim V",_G.PlayerHunter,function(Killzps)
...
P:Button("t im Hi Sinh",function()
    ...
    P:Toggle("Bc Tc V3",_G.ActiveV3,function(V)
        _G.ActiveV3 = V
    end)
    ...
    P:Toggle("Bc Tc V4",_G.ActiveV4,function(V)
        _G.ActiveV4 = V
    end)
    ...
    P:Toggle("i Trên Nc",true,function(V)
        _G.WalkWater = V
    end)
    ...
    P:Toggle("Xuyên Tng",_G.NoClip,function(V)
        _G.NoClip = V
    end)
...
P:Seperator("Ch S")
  ...
  local Pointstat = P:Label("im Ch S")
    
    spawn(function()
        while wait() do
            pcall(function()
                Pointstat:Set("im Ch S: "..tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value))
            end)
        end
    end)
...
local Fruit = P:Label("Trái: ")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Sword:Set("Kim: "..game.Players.localPlayer.Data.Stats.Sword.Level.Value)
            end)
        end
    end)
...
P:Toggle("T ng Nâng Ch S",_G.Stats_Kaitun,function(V)
_G.Stats_Kaitun = V
end)
...
P:Toggle("Kim",false,function(V)
sword = V
end)
...
-------------------------------------------------------------------------------------------------------- 
    ...
    R:Dropdown("Chn Con Chip",Raidslist,function(V)
        _G.SelectChip = V
    end)
    
    R:Toggle("Mua chip ã Chn",_G.SelectDungeon,function(V)
        _G.SelectDungeon = V
    end)
    ...
    R:Toggle("Mua Chip ã Chn",_G.BuyChip,function(V)
        _G.BuyChip = V
    end)
    ...
    R:Toggle("Bt u Vào Tp Kích",_G.StartRaid,function(V)
        _G.StartRaid = V
    end)
    ...
    R:Button("Bt u Tp Kích",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
        ...
        R:Button("Bay n o k Tip",function()
        pcall(function()
        ...
        R:Toggle("T ng Qua o K Tip",_G.Dungeon,function(V)
        _G.Dungeon = V
...
spawn(function()
    ...
    R:Toggle("Git Quái Xung Quanh",nil,function(V)
    _G.Kill_Aura = V
    end) 
...
spawn(function()
    ...
    R:Toggle("T ng Thc Tnh",_G.Awakener,function(V)
        _G.Awakener = V
    end)
    ...
    if World2 then
        R:Button("Bay n Ch Tp Kích",function()
    ...
    if World2 then
        R:Button("Bay n Phòng Thc Tnh",function()
    ...
    R:Seperator("Kim KoKo")
    
 R:Toggle("ánh Law", _G.OderSword,function(V)
     _G.OderSword = V
    StopTween( _G.OderSword)
    end)
    
    R:Toggle("ánh Law i Máy Ch", _G.OderSwordHop,function(V)
         _G.OderSwordHop = V
    end)
    ...
    R:Button("Bt u Vào Tp Kích Law",function()
        if World2 then
...
--------------------------------------------------------------------------------------------------------
    ...
    T:Button("Dch Chuyn V Bin 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:Button("Dch Chuyn V Bin 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:Button("Dch Chuyn V Bin 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
T:Seperator("Cng Dch Chuyn")
    
    if World1 then
        T:Dropdown("Chn Cng",{
            "Sky Island 1",
            "Sky Island 2",
            "Under Water Island",
    ...
    T:Toggle("Dch Chuyn n Cng ã Chn",false,function(V)
        _G.TeleFast = V
...
--------------------------------------------------------------------------------------------------------
    ...
    S:Button("Mua Nhy Liên Tc [ 10,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    ...
    S:Button("Mua Dch Chuyn [ 25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
...
S:Toggle("Mua Tt C", false, function(t)
    ...
    S:Seperator("Mua Bng im Tím")

S:Button("Khôi Phc Ch S (2.5K F)", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:Button("i Tc (3K F)", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)

S:Button("Mua Tc Cyborg (2.5K F)", function()
    local args = {
		[1] = "CyborgTrainer",
		[2] = "Buy"
	}
...
--------------------------------------------------------------------------------------------------------
    ...
    _G.SelectFruit = ""
    D:Dropdown("Chn Trái",Table_DevilFruitSniper,function(V)
        _G.SelectFruit = V
    end)
    
    D:Toggle("Mua Trái ã Chn",_G.BuyFruitSniper,function(V)
        _G.BuyFruitSniper = V
    end)
    
    D:Seperator("Khác")
    
    D:Dropdown("Chn Trái  n",Table_DevilFruitSniper,function(V)
        _G.SelectFruitEat = V
    end)
    
    D:Toggle("n Trái ã Chn",_G.EatFruit,function(V)
        _G.EatFruit = V
    end)
    ...
    D:Button("M Shop Bán Trái",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    D:Toggle("T ng Lu Trái",_G.StoreFruit,function(V)
        _G.StoreFruit = V
    end)
...
spawn(function()
    ...
    D:Toggle("Dch Chuyn n Nht Trái",_G.Grabfruit,function(V)
    _G.Grabfruit = V
    end)
    spawn(function()
			while wait(.1) do
    ...
    D:Toggle("Bay n Nht Trái",_G.Tweenfruit,function(V)
    _G.Tweenfruit = V
...
--------------------------------------------------------------------------------------------------------
    ...
    Mc:Button("Vào Li Máy Ch",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    Mc:Button("i Máy Ch",function()
        Hop()
    end)
    
    Mc:Button("i Máy Ch Ít Ngi",function()
    ...
    Mc:Button("Sao Chép Id Máy Ch",function()
	setclipboard(tostring(game.JobId))
	end)
	
    Mc:Textbox("Nhp Id Máy Ch", true, function(V)
	_G.Job = V
	end)

	Mc:Button("Vào Máy Ch ã Nhp id",function()
	game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
	end)
	
    Mc:Seperator("Khác")
    
    Mc:Button("Tên Tiêu ",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Mc:Button("M Bn Haki Màu",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)
      
Mc:Seperator("Phe")
    
    Mc:Button("Vào Phe Hi Tc",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Mc:Button("Vào Phe Hi Quân",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
Mc:Seperator(" Khác ")

Mc:Toggle("Chng AFK", true, function()
...
repeat wait() until game:IsLoaded() 
    ...
    Mc:Dropdown("Chn Code Khôi Phc Ch S",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(V)
        _G.CodeSelect = V
    end)
    
    Mc:Button("Nhp Code ã Chn",function()
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
    end)
    
    Mc:Seperator("Tình trng")
    
    Mc:Dropdown("Chn Tình Trng Haki",{"Tình Trng 0","Tình Trng 1","Tình Trng 2","Tình Trng 3","Tình Trng 4","Tình Trng 5"},function(V)
        _G.SelectStateHaki = V
    end)
    
    Mc:Button("Change Buso Haki State",function()
        if _G.SelectStateHaki == "Tình Trng 0" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",0)
        elseif _G.SelectStateHaki == "Tình Trng 1" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",1)
        elseif _G.SelectStateHaki == "Tình Trng 2" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",2)
        elseif _G.SelectStateHaki == "Tình Trng 3" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",3)
        elseif _G.SelectStateHaki == "Tình Trng 4" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",4)
        elseif _G.SelectStateHaki == "Tình Trng 5" then
